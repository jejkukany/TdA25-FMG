		...
		<div className="min-h-screen bg-background flex flex-col items-center justify-center gap-16">
			...
			<main className="container mx-auto p-4 md:p-6 flex flex-col-reverse md:flex-row gap-8 items-center md:justify-between w-full md:h-[90vh] text-center md:text-left">
				...
				>
					...
					<p className="text-muted-foreground">
						...
						Improve your strategy and take on various puzzles!
					</p>

					<div className="space-y-4 flex flex-col items-center md:items-start">
						<Link href="/game" className="w-1/2">
							<Button
								className="w-full h-12 font-medium px-2 sm:px-4 text-lg"
								size="lg"
							>
								Local Multiplayer
							</Button>
			...
			>
				<div className="flex-1 flex flex-col gap-6 text-center">
					...
					<p className="text-muted-foreground">
						Challenge your friends to a thrilling game of Tic Tac
						Toe! Show your strategic moves and outsmart your
						opponent!
					</p>
			...
			>
				<div className="flex-1 flex flex-col gap-6 text-center">
					...
					<p className="text-muted-foreground">
						Get ready for a variety of challenging puzzles! Test
						your problem-solving skills and see how quickly you can
						solve them.
					</p>
					<div className="flex justify-center">
						<Link href="/games" className="w-1/2">
